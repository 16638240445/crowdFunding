...
<div id="header">
    <div class="heade-con">
        <div class="logo"><a href=""><img src="<%=basePath %>images/LOGO.png"/></a></div>
        <div class="nav posa">
            <ul>
                <li><a class="vcolor" href="index.html">首页</a></li>
                <li><a href="<%=basePath %>gyzc-list.html">公益众筹</a></li>
                <li><a href="<%=basePath %>cop.html">常见问题</a></li>
                <li><a href="<%=basePath %>ly-list.html">众筹资讯</a></li>
                <li><a href="<%=basePath %>new-product.html" style="">发布项目</a></li>
            </ul>
        </div>
        <div class="search">
            <form action="">
...
<ul>
    ...
    <li><i class="i1"></i><a class="u-hover" href="<%=basePath %>user/publish.action">发起的项目</a></li>
...
<div class="user-conr_tab">
    <ul>
        ...
        <div class="user-conr_tab2">
            <ul>
                <li class="curq2"><jsp:include page="<%=basePath %>user/user_projects.jsp"/></li>
