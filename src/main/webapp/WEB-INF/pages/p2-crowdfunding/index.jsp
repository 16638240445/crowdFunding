...
<!-- Swiper -->
  <div class="swiper-container">
    <div class="swiper-wrapper">
      <div class="swiper-slide"><img src="<%=basePath %>images/1525661829.jpg"></div>
      <div class="swiper-slide"><img src="<%=basePath %>images/1525661991.png"> </div>
    </div>
    <!-- Add Pagination -->
...
<div class="content">
    ...
    <div class="index-mrjx">
        ...
        <div class="index-mrjx_min"><a href=""><img src="<%=basePath %>images/pruduct1_32.jpg" alt=""/></a></div>
        <div class="index-mrjx_right">
            <div class="index-pruduct">
                <ul>
                    <li>
                        <div class="index-plidiv1"><a href=""><img src="<%=basePath %>images/pruduct2_34.jpg" width="237px" height="155px" alt=""/></a><div class="index-p_dkz">等款中</div>
                        </div>  <p>
    ...
    <div class="ggt2"><a href=""><img src="<%=basePath %>images/ggt2_39.jpg" alt=""/></a></div>
...
<div class="index-jjks">
    ...
    <div class="index-jjkscon">
        <ul>
            <li>
             <div class="index-jjkscon1"><a href=""><img src="<%=basePath %>images/producc_47.jpg" width="238" height="155" alt=""/></a><div class="index-j_dkz">预热中</div></div>
...
<div class="ggt2 ggt3"><a href=""><img src="<%=basePath %>images/ggt2_39.jpg" alt=""/></a></div>
<div class="index-jjks">
            ...
            <div class="index_tab">
                <dl class="index_tab1">
                    ...
                    <div class="index_tab1_5">
                        <a><i><img src="<%=basePath %>images/index-tbpu_07.jpg"></i>支持人数<span>63</span></a>
                        <a><i><img src="<%=basePath %>images/index-tbpu_10.jpg"></i>剩余时间<span>28天</span></a>
                    </div>
...
<div class="ggt2 ggt4"><a href=""><img src="<%=basePath %>images/ggt2_39.jpg" alt=""/></a></div>-->
</div>
<div id="bottom">
    <div class="bot-con1">
        <ul>
