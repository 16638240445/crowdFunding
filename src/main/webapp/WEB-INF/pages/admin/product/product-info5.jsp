		...
		<div class="row">
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<ul class="nav nav-tabs">
					...
					<li role="presentation" class="active"><a href="<%=basePath %>admin/productsDetail_5.action?psId=${ps.psId }&psUsId=${ps.psUsId }">项目跟踪</a></li>
				</ul>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="buttons" align="center">
								<a class="btn btn-default" href="<%=basePath%>admin/products.action">返回</a>
							</div>
						</div>
					</div>
				</div>
