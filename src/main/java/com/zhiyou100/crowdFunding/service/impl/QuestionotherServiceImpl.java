...
import com.zhiyou100.crowdFunding.mapper.IQuestionotherMapper;
...
public class QuestionotherServiceImpl implements IQuestionotherService {
	...
	@Autowired
	private IQuestionotherMapper mapper;
	...
	@Override
	public Questionother findById(Integer id) throws Exception {
		return this.mapper.findById(id);
	}

	@Override
	public List<Questionother> findAll(Map<String, Object> map) throws Exception {
		return this.mapper.findAll(map);
	}

	@Override
	public List<Questionother> findAllSplit(Map<String, Object> map) throws Exception {
